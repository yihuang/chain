...
from common import wait_for_pending, wait_for_validators
...
# FIXME, needs to wait for at least one block.
time.sleep(5)
...
print('Wait for wallet to sync...')
# FIXME, fix this after #929 fixed.
# wait_for_pending(rpc, enckey)
time.sleep(2)
...
print('join txid', txid)

print('Sleep 1 second and sync')
time.sleep(1)
rpc.wallet.sync(enckey=enckey)
